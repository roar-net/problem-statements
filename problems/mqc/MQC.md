...
A quasi-clique is a subgraph whose density is at least $\gamma$ $(0 < \gamma \leq 1)$. 
The Maximum Quasi-clique (MQC) problem [1] is a combinatorial problem that consists of finding a quasi-clique of maximum number of vertices.
...
[2] Asahiro, Y., Iwama, K., 1995. Finding dense subgraphs, in: Staples, J., Eades, P., Katoh, N., Moffat, A. (Eds.), Algorithms
and Computations, Springer Berlin Heidelberg, Berlin, Heidelberg. pp. 102–111. [https://doi.org/10.1007/BFb0015413](https://doi.org/10.1007/BFb0015413) 
